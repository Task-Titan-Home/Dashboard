...
import signupMutation from "@/app/graphql/user/signup";
...
export default function Signup() {
  ...
  const [formData, setFormData] = useState({
    ...
    name: "", // Make sure this is included and has a value
  });
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Assuming the mutation and variable naming are correct
      const variables = {
        userRole: formData.userRole,
        email: formData.email,
        name: formData.name, // Make sure this is included and has a value
      ...
      router.push("/pages/auth/signup/check-your-email");
    } catch (error) {
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-center gap-x-3 py-3 border border-gray-700 rounded-xl hover:border-gray-600 hover:bg-gray-800/50 transition-all duration-200 group">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
